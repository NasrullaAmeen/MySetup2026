...
modified: 2026-09-17 21:17:42 +05
---
...
Defines how AI agents (Claude, opencode, etc.) operate inside `~/Projects/Setup/`. Notes live in `docs/`. Index: [docs/README.md](./docs/README.md).
